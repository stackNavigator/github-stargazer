import {
  GET_REPO, GET_REPO_START, GET_REPO_SUCCESS, GET_REPO_FAIL, SORT_REPOS, REMOVE_REPO, GET_REPO_LANGUAGES,
  GET_REPO_LANGUAGES_SUCCESS, CHANGE_REPO_NAME, CLEAR_REPO_NAME, CLEAR_REPO_ADDITION
} from './action-types'
...
export const getRepoLanguages = repoName => ({ type: GET_REPO_LANGUAGES, repoName })
export const getRepoLanguagesSuccess = (targetName, languages) => ({ type: GET_REPO_LANGUAGES_SUCCESS, targetName, languages })
