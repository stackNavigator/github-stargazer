...
describe('Details component', () => {
  it('renders correctly without info prop', () => {
    const component = renderer.create(<Details headerCaption="Test Header" />).toJSON()
...
describe('ListItem component', () => {
  it('renders full_name and stars count correctly', () => {
    const component = renderer.create(<ListItem leftCaption="default/repo" rightCaption="15001" />).toJSON()
    expect(component).toMatchSnapshot()
  })
})
